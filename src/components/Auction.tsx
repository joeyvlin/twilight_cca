    ...
    >
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-lg p-3 sm:p-4 md:p-5 h-full w-full flex flex-col">
        ...
        <div className="grid grid-cols-2 grid-rows-3 gap-3 sm:gap-4 md:gap-5 flex-1 auto-rows-fr">
          <div ref={block1Tilt} id="current-block" className={`border border-gray-700 rounded-lg px-2 sm:px-3 md:px-4 py-4 sm:py-5 md:py-6 bg-gradient-to-r from-gray-800/50 to-transparent ${themeClasses.hoverBorderAccent} transition-colors flex flex-col items-center justify-center text-center cursor-pointer`} style={{ transformStyle: 'preserve-3d' }}>
            <div className="text-xs sm:text-sm text-gray-400 mb-1 sm:mb-2">Current Block</div>
            <div className="text-lg sm:text-xl md:text-2xl font-bold">#{currentBlock.toLocaleString()} / {totalBlocks.toLocaleString()}</div>
          </div>
          <div ref={block2Tilt} id="clearing-price" className={`border border-gray-700 rounded-lg px-2 sm:px-3 md:px-4 py-4 sm:py-5 md:py-6 bg-gradient-to-r from-gray-800/50 to-transparent ${themeClasses.hoverBorderAccent} transition-colors flex flex-col items-center justify-center text-center cursor-pointer`} style={{ transformStyle: 'preserve-3d' }}>
            <div className="text-xs sm:text-sm text-gray-400 mb-1 sm:mb-2">Last Clearing Price</div>
            <div className={`text-lg sm:text-xl md:text-2xl font-bold ${themeClasses.textAccent}`}>${lastClearingPrice.toFixed(2)}</div>
          </div>
          <div ref={block3Tilt} id="block-ends" className={`border border-gray-700 rounded-lg px-2 sm:px-3 md:px-4 py-4 sm:py-5 md:py-6 bg-gradient-to-r from-gray-800/50 to-transparent ${themeClasses.hoverBorderAccent} transition-colors flex flex-col items-center justify-center text-center cursor-pointer`} style={{ transformStyle: 'preserve-3d' }}>
            <div className="text-xs sm:text-sm text-gray-400 mb-1 sm:mb-2">Block Ends In</div>
            <div className={`text-lg sm:text-xl md:text-2xl font-bold ${themeClasses.textAccent}`}>{formatTime(countdown1)}</div>
          </div>
          <div ref={block4Tilt} id="auction-ends" className={`border border-gray-700 rounded-lg px-2 sm:px-3 md:px-4 py-4 sm:py-5 md:py-6 bg-gradient-to-r from-gray-800/50 to-transparent ${themeClasses.hoverBorderAccent} transition-colors flex flex-col items-center justify-center text-center cursor-pointer`} style={{ transformStyle: 'preserve-3d' }}>
            <div className="text-xs sm:text-sm text-gray-400 mb-1 sm:mb-2">Auction Ends In</div>
            <div className={`text-lg sm:text-xl md:text-2xl font-bold ${themeClasses.textAccent}`}>{formatTime(countdown2)}</div>
          </div>
          <div ref={block5Tilt} id="tokens-allocated" className={`col-span-2 border border-gray-700 rounded-lg px-2 sm:px-3 md:px-4 py-4 sm:py-5 md:py-6 bg-gradient-to-r from-gray-800/50 to-transparent ${themeClasses.hoverBorderAccent} transition-colors flex flex-col items-center justify-center text-center cursor-pointer`} style={{ transformStyle: 'preserve-3d' }}>
            <div className="text-xs sm:text-sm text-gray-400 mb-1 sm:mb-2">Allocated Tokens</div>
